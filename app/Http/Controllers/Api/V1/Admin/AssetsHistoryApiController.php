...
class AssetsHistoryApiController extends Controller
{
    public function index()
    {
        ...
        return new AssetsHistoryResource(AssetsHistory::with(['asset', 'status', 'location', 'assigned_user', 'created_by'])->get());
    }
    ...
    public function show(AssetsHistory $assetsHistory)
    {
        ...
        return new AssetsHistoryResource($assetsHistory->load(['asset', 'status', 'location', 'assigned_user', 'created_by']));
    }
}

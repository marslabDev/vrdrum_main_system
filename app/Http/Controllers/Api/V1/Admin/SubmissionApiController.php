...
use App\Http\Resources\Admin\SubmissionResource;
...
class SubmissionApiController extends Controller
{
    public function index()
    {
        ...
        return new SubmissionResource(Submission::with(['student_work', 'created_by'])->get());
    }
    ...
    public function show(Submission $submission)
    {
        ...
        return new SubmissionResource($submission->load(['student_work', 'created_by']));
    }

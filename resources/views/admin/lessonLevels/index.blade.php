...
@can('lesson_level_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'LessonLevel', 'route' => 'admin.lesson-levels.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.lessonLevel.title_singular') }} {{ trans('global.list') }}
    </div>

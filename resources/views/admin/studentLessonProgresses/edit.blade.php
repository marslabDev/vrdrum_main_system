    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.student-lesson-progresses.update", [$studentLessonProgress->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('student_efk') ? 'is-invalid' : '' }}" type="number" name="student_efk" id="student_efk" value="{{ old('student_efk', $studentLessonProgress->student_efk) }}" step="1" required>

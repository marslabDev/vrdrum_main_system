    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.order-items.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_qty') ? 'is-invalid' : '' }}" type="number" name="product_qty" id="product_qty" value="{{ old('product_qty', '1') }}" step="0.01" min="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('net_total') ? 'is-invalid' : '' }}" type="number" name="net_total" id="net_total" value="{{ old('net_total', '0') }}" step="0.01" required>

        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.product.fields.parent') }}
                        </th>
                        <td>
                            {{ $product->parent->name ?? '' }}
                        </td>
...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#parent_products" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="parent_products">
            @includeIf('admin.products.relationships.parentProducts', ['products' => $product->parentProducts])
        </div>
